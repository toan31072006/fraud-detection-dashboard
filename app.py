...
# --- CUSTOM CSS FOR "DARK FINTECH PRO" LOOK ---
st.markdown("""
    <style>
    /* Tổng quan màu nền app (Dark Navy) */
    .stApp {
    ...
    /* Thiết kế lại các KPI Metrics (Thẻ số liệu Dark Mode) */
    div[data-testid="metric-container"] {
        background-color: #1e293b;
        border: 1px solid #334155;
        border-top: 3px solid #3b82f6; /* Viền nhấn màu Neon Blue */
        padding: 15px 20px;
        border-radius: 12px;
    ...
    div[data-testid="metric-container"]:hover {
        ...
        box-shadow: 0 10px 25px rgba(59, 130, 246, 0.2); /* Sáng lên khi di chuột */
        border-color: #3b82f6;
    }
...
# --- TẠO HÀM CHUẨN HÓA GIAO DIỆN BIỂU ĐỒ PLOTLY (DARK MODE) ---
def apply_pro_theme(fig):
    """Đồng bộ toàn bộ biểu đồ sang nền tối, đường viền neon"""
    fig.update_layout(
    ...
    fig.update_yaxes(gridcolor="#1e293b", zeroline=False, linecolor="#334155")
    return fig
...
if not df.empty:
    ...
    with st.sidebar:
        st.markdown("<h2 style='text-align: center; color: #3b82f6;'>🛡️ RISK PORTAL</h2>", unsafe_allow_html=True)
        st.markdown("<br>", unsafe_allow_html=True)
        
        # --- ĐÃ SỬA CÁC ICON CHUẨN BOOTSTRAP ĐỂ ĐẢM BẢO HIỂN THỊ 100% ---
        page = option_menu(
            ...
            styles={
                ...
                "nav-link": {"font-size": "14px", "text-align": "left", "margin":"5px", "color": "#cbd5e1", "font-weight": "500", "border-radius":"8px"},
    ...
    # Bảng màu Neon cho Dark Mode
    COLOR_MAP = {'HighRisk': '#FF2A5F', 'MediumRisk': '#FFB302', 'LowRisk': '#00E676', 'Safe': '#00D2FF'}
    ...
    if page == "Industry Overview":
        ...
        with r1_c1:
            ...
            fig1 = px.line(yearly_stats, x='Year', y='fraud_score', markers=True, title="Average Industry Fraud Score Trend", color_discrete_sequence=['#FF2A5F'])
            fig1.add_hline(y=fraud_threshold, line_dash="dash", line_color="#FFB302")
        ...
        with r2_c1:
            ...
            fig3 = go.Figure(data=[
                go.Bar(name='Total Revenue', x=rev_prof['Year'], y=rev_prof['Rev'], marker_color='#00D2FF'),
                go.Bar(name='Total Profit', x=rev_prof['Year'], y=rev_prof['Net_Profit'], marker_color='#00E676')
            ])
    ...
    # ====================================================
        ...
        with r3_c1:
            ...
            fig6 = px.bar(flag_sums, x='Count', y='Red Flag Type', orientation='h', title="Most Common Fraud Types", color='Count', color_continuous_scale='Plasma')
        ...
        with r3_c2:
            ...
            fig7.add_hline(y=0, line_dash="dot", line_color="#475569")
            fig7.add_vline(x=0, line_dash="dot", line_color="#475569")
    ...
    # ====================================================
        ...
        if not df_company.empty:
            ...
            with r5_c1:
                fig10 = go.Figure()
                fig10.add_trace(go.Bar(x=df_company['Year'], y=df_company['Net_Profit'], name='Profit', marker_color='#00D2FF', yaxis='y1'))
                fig10.add_trace(go.Scatter(x=df_company['Year'], y=df_company['fraud_score'], name='Fraud Score', mode='lines+markers', marker=dict(color='#FF2A5F'), yaxis='y2'))
            ...
            with r5_c2:
                fig11 = go.Figure(data=[
                    go.Bar(name='Revenue', x=df_company['Year'], y=df_company['Rev'], marker_color='#00E676'),
                    go.Bar(name='COGS', x=df_company['Year'], y=df_company['COGS'], marker_color='#FFB302')
                ])
            ...
            with r6_c1:
                fig12 = go.Figure()
                fig12.add_trace(go.Scatter(x=df_company['Year'], y=df_company['Net_Profit'], name='Net Profit', mode='lines+markers', line=dict(color='#00D2FF')))
                fig12.add_trace(go.Scatter(x=df_company['Year'], y=df_company['Operating_Cash_Flow'], name='Operating Cash Flow', mode='lines+markers', line=dict(color='#A855F7')))
    ...
    # ====================================================
        ...
        with r9_c1:
            ...
            fig19 = px.imshow(corr_matrix, text_auto=True, color_continuous_scale='Plasma', title="Correlation Matrix of Variables")
            st.plotly_chart(apply_pro_theme(fig19), use_container_width=True)

        with r9_c2:
            fig20 = px.scatter_3d(df_filtered, x='Total_Assets', y='Total_Liabilities', z='Operating_Cash_Flow', color='risk_level', size='fraud_score', title="3D Space: Assets - Liabilities - Cash Flow", color_discrete_map=COLOR_MAP, opacity=0.8)
            fig20.update_layout(scene=dict(xaxis_title='Assets', yaxis_title='Liabs', zaxis_title='Cash Flow'))
    ...
    # ====================================================
        ...
        with r11_c1:
            ...
            fig24 = px.treemap(top_rev, path=[px.Constant("Market"), 'Symbol'], values='Rev_Plot', color='fraud_score', color_continuous_scale='Plasma', title="Top 50 Companies Heatmap (Size = Rev, Color = Risk)")
        ...
        with r12_c1:
            ...
            fig26 = go.Figure(data=[
                ...
                go.Bar(name='Long-Term Debt', x=cap_struct['Year'], y=cap_struct['LT_Debt'], marker_color='#FF2A5F')
            ])
